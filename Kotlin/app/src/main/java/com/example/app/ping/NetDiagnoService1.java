 ...
 */
public class NetDiagnoService1 extends NetAsyncTaskEx<String, String, String>
    ...
    private NetDiagnoListener1 _netDiagnolistener; // 将监控日志上报到前段页面
    private TelephonyManager _telManager = null; // 用于获取网络基本信息

    public NetDiagnoService1() {
        super();
    }
     ...
     * 初始化网络诊断服务
     */
    public NetDiagnoService1(Context context,
                             String theAppName, String theAppVersion, String theUID,
                             String theDeviceID, String theDormain, NetDiagnoListener1 theListener) {
        super();
